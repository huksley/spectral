...
export interface IExampleValidationOptions {
  schemaPath: string;
  field?: string;
}

export const buildAsyncApi2SchemaObjectValidator = (): AJV.Ajv => {
...
export const asyncApi2PayloadValidation: IFunction<IExampleValidationOptions> = function(
